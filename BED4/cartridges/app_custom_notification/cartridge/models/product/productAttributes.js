...
function getAllAttrValues(
    ...
    return collections.map(attrValues, function (value) {
        ...
        // add url if product is selectable and if is not selectable
...
function getAttrResetUrl(values, attrID) {
    ...
    for (var i = 0; i < values.length; i++) {
        ...
        if (!value.images) {
            ...
            // add url if product is selectable and if it is not selectable
...
function VariationAttributesModel(
    ...
    collections.forEach(allAttributes, function (attr) {
        ...
        // change function to add url to "nonselectable" products
